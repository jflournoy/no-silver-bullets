...
Code for these analyses is available in the `manuscript-preprint_v1.0.0` release as `analyses.qmd`, here: [https://github.com/jflournoy/no-silver-bullets](https://github.com/jflournoy/no-silver-bullets).
