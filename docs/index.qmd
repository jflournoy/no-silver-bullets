...
Code for these analyses is available as `analyses.qmd`, here: [https://github.com/jflournoy/no-silver-bullets](https://github.com/jflournoy/no-silver-bullets). Data are considered proprietary and are not available to be shared.
