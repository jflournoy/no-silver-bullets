...
acknowledgements: |
  We would like to thank Kristen Foster-Marks, and Bennet Cook for their helpful advice on this research.
...
:::{#fig-org-size}
![](plots/org_size_hist.png){width=3}
...
::: {#fig-quarter fig-scap="Within-quarter month doesn't affect cycle time" fig-alt="Within-quarter month doesn't affect cycle time"}

![](plots/cycle_time_full_intx_lin_remonth_quarter.png){width=4in}
...
![](plots/cycle_time_full_intx_lin_remonth_month_num.png){width=4in}
...
![](plots/cycle_time_full_intx_lin_remonth_coding_days.png){width=4in}
...
![](plots/cycle_time_full_intx_lin_remonth_merged_prs.png){width=4in}
...
![](plots/cycle_time_full_intx_lin_remonth_defect_tickets.png){width=4in}
...
![](plots/cycle_time_full_intx_lin_remonth_degree_cent.png){width=4in}
...
![](plots/cycle_time_full_intx_lin_remonth_pr_comments.png){width=4in}
...
![Avg. coding days per Week](plots/avg_coding_days_per_week_eff_size.png){#fig-heatmaps-coding}



![Total merged PRs](plots/total_merged_prs_eff_size.png){#fig-heatmaps-prs}



![Defect tickets percentage](plots/defect_tickets_pct_indiv_eff_size.png){#fig-heatmaps-defects}



![Degree centrality](plots/degree_centrality_monthly_100_eff_size.png){#fig-heatmaps-centrality}



![Comments per PR](plots/comments_per_pr_eff_size.png){#fig-heatmaps-comments}
...
![](plots/cycle_time_full_intx_nlq_pp_check.png){width=4in}
...
![](plots/cycle_time_full_intx_nlq_pp_check_summary.png){width=4in}
...
::: {#fig-bw-ct-traj fig-scap="Individual observations of cycle time are highly variable across the year" fig-alt="Individual observations of cycle time are highly variable across the year"}

![](plots/cycle_time_full_intx_lin_remonth_post_pred_ids.png){width=4in}
...
::: {#fig-wi-ct-traj fig-scap="Individual month-to-month deviations from year-average cycle time are highly variable across the year" fig-alt="Individual month-to-month deviations from year-average cycle time are highly variable across the year"}

![](plots/cycle_time_full_intx_nlq_post_pred_ids_win.png){width=4in}
...
::: {#fig-ct-pp-traj fig-scap="Variability in cycle time within-person across time overwhelms subtle differences in averages" fig-alt="Variability in cycle time within-person across time overwhelms subtle differences in averages"}

![](plots/cycle_time_full_intx_nlq_combined_post_pred_counterfactual.png){width=4in}
