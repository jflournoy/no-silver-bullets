...
\abstract{Understanding factors that influence software development
velocity is crucial for engineering teams and organizations, yet
empirical evidence at scale remains limited. A more robust understanding
of the dynamics of cycle time may help practitioners avoid pitfalls in
relying on velocity measures while evaluating software work. We analyze
cycle time---a widely-used metric measuring time from ticket creation to
...
% keywords
\keywords{cycle time,  productivity,  software
engineering,  collaboration,  coding time,  task scoping,  hierarchical
modeling}
...
are measured tend to report higher perceived productivity
...
The measure of productivity used is something half-way between an
objective measurement and self-report: an unspecified machine-learning
model trained on expert ratings of the quality of, and work necessary to
complete, 70 commits
\citep{denisov-blanchPredictingExpertEvaluations2024}. Unlike prior
work, this method lacks both the transparency of ``objective'' measures
and the temperance of self-report measures.
...
process and (4) the use of software design and testing tools
...
\includegraphics[width=0.03125in,height=\textheight]{plots/org_size_hist.png}

}

\caption{\label{fig-org-size}}
...
As such, we used the percentage of defect tickets as another measure of
...
in the analysis of social networks \citep{wattsNewScienceNetworks2004},
we employed a framework where developers were treated as nodes within
the network, and their interactions in the form of Pull Requests (PRs)
were regarded as connections. In other words, any contribution of code
to the same pull request constituted a collaboration edge between
developers. We normalized each centrality value by dividing by the total
number of developers constituting the organizational network. The
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_lin_remonth_quarter.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_lin_remonth_month_num.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_lin_remonth_coding_days.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_lin_remonth_merged_prs.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_lin_remonth_defect_tickets.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_lin_remonth_degree_cent.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_lin_remonth_pr_comments.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_nlq_pp_check.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_nlq_pp_check_summary.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_lin_remonth_post_pred_ids.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_nlq_post_pred_ids_win.png}
...
\includegraphics[width=4in,height=\textheight]{plots/cycle_time_full_intx_nlq_combined_post_pred_counterfactual.png}
...
\citep{devanbuBeliefEvidenceEmpirical2016, kitchenhamEvidencebasedSoftwareEngineering2004, sjobergFutureEmpiricalMethods2007}.
...
\citep{baltesSamplingSoftwareEngineering2021a}.
...
\item
  ...
  revealing\footnote{''When we suggest that an innovator---be it an
    ...
    et al., 2003).''
    \citep[295]{vonhippelFreeRevealingPrivatecollective2006}}'' may
  ultimately prove more profitable, as described by
...
We would like to thank Kristen Foster-Marks, and Bennet Cook for their
