...
\subcaption{\label{fig-heatmaps-prs}Avg. coding days per Week}
...
\subcaption{\label{fig-heatmaps-defects}Total merged PRs}
...
\subcaption{\label{fig-heatmaps-centrality}Defect tickets percentage}
...
\subcaption{\label{fig-heatmaps-comments}Degree centrality}
