...
\hypersetup{
  ...
  pdfauthor={John C. Flournoy; Carol S. Lee; Maggie Wu; Catherine M. Hicks},
...
\def\asep{\And }
\author{\textbf{John C.
Flournoy}~\orcidlink{0000-0003-1735-1221}\\\\Pluralsight\\Westlake,
TX\\\href{mailto:jcflournoyphd@pm.me}{jcflournoyphd@pm.me}\asep\textbf{Carol
S. Lee}~\orcidlink{0000-0002-6909-6157}\\\\Pluralsight\\Westlake,
TX\\\asep\textbf{Maggie Wu}\\\\Pluralsight\\Westlake,
TX\\\asep\textbf{Catherine M.
Hicks}~\orcidlink{0009-0007-5657-1661}\\\\Pluralsight\\Westlake,
TX\\\\Catharsis\\San Diego, CA\\}
\date{2025-03-06}
\begin{document}
\maketitle
\begin{abstract}
...
knowledge to deliver value to end-users, maintain competitiveness, and
...
2024b, 2024a; Riggins 2023; Terhorst-North 2023b, 2023a; Walker 2023b,
...
deploy frequency, and change failure rate. The broader software
engineering community has emphasized similar constructs through the
research program DevOps Research and Assessment (DORA), which identified
four key measures of software delivery performance: lead time,
deployment frequency, change failure rate, and mean time to recovery
(Forsgren, Humble, and Kim 2018). While cycle time is not identical to
these measures, it overlaps conceptually---particularly with lead
time---in capturing aspects of delivery speed. Positioning cycle time
alongside these measures situates it within a family of indicators
concerned with the timeliness and reliability of software delivery, even
though the operational definitions vary across contexts.

The common thread across these metrics is that the unit of work is
defined by the team or company in relation to goals that serve the
strategic interests of the project. While there is a good deal of nuance
with respect to what goes into setting these units up, they are both
discrete (and so ``objective''-feeling) but also defined, often
...
what leads to a fluid-feeling development and release cycle (André N.
Meyer et al. 2021).
...
2003). We focus in this paper on factors from part 3, software
development processes, in part because measurements of these processes
continue to gather significant interest from the technology industry and
are plausibly mobile levers that can be manipulated at the level of an
...
review rates (Flow, n.d.; Gralha 2022; Waydev 2021). There has also been
some work looking at this empirically which supports the idea that
collaboration under certain conditions does improve productivity
Gousios, Pinzger, and Deursen (2014). We focus on these three areas as
possible factors that impact cycle time.
...
considered proprietary and are not available to be shared. This research
used aggregated, anonymized GitHub activity data routinely collected
through our company's normal operations and permitted by our Terms of
Service. No personal information was gathered specifically for this
study, and strict protocols were followed to prevent re-identification
of individuals or organizations. Because the dataset was pre-existing,
fully anonymized, and did not involve direct interaction with human
subjects, the research is exempt from IRB review under 45 CFR
\S 46.104(d)(4)(ii). All data was stored on secure systems with limited
access, ensuring both data integrity and confidentiality.
...
users, with a long tail of larger organizations. Note that ``users''
generally refers to developers or other individuals creating and closing
tickets.}
...
of the median for April. Depending on how organizations actually use
tickets in practice, it is not guaranteed that work has not already
begun prior to ticket opening.
...
seven to aid in interpretation. Based on conversations with software
developers, we understand that making small commits frequently is often
considered best-practice, but the fact that commits can be made
independent of actual coding time means that our proxy measure for
coding days is imperfect.
...
2019; Zhang et al. 2022). For a given software development goal, if we
assume the set of commits necessary to accomplish that goals remains the
same, more pull requests suggests that the task was broken down into
smaller discrete goals in a way that groups more closely related
subtasks together than one large pull request. Making smaller, more
frequent pull requests is also itself a way to break up the task for
code reviewers in a way that is thought to improve productivity. As
such, we used the number of total merged pull requests as one measure of
task scoping. To calculate this, we counted the number of merged pull
...
Rosser and Norton 2021; Toxboe 2023). As such, we used the percentage of
defect tickets as another measure of task scoping to represent unplanned
work that may interfere with timely completion of planned work. This may
also be a downstream signal of individuals' opportunity for focused work
time and code quality. To account for this possibility, for each user,
for each month, we computed the percent of tickets that were defect
tickets.
...
the development and review process. However, see Bacchelli and Bird
(2013) suggesting that more comments may reflect, for example, poorer
code quality.
...
2018, 2017), interface the Stan probabilistic programming language for
Bayesian sampling (v2.35.0, Team 2024), with the \texttt{cmdstanr}
...
\textsubscript{Source:
\href{https://jflournoy.github.io/no-silver-bullets/index.qmd.html}{Article
Notebook}}
...
\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Parameter}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Posterior\ Median}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{1}}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Lower\ 95\%\ HDI}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{2}}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Upper\ 95\%\ HDI}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{2}}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Sign\ Probability}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{3}}}}}} \\
...
\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Intercept\ log(λ)}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{14.3484}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{14.2727}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{14.4282}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Intercept\ log(k)}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.1214}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0807}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.1585}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Within-quarter\ month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0085}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0188}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0013}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 95\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Team\ size}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0001}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0644}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0560}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 50\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Avg.\ coding\ days/week\ (within-person)}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0794}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0911}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0677}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Avg.\ coding\ days/week}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0839}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.1100}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0587}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Total\ merged\ PRs\ (within-person)}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0127}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0155}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0097}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Total\ merged\ PRs}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0083}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0139}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0027}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Defect\ tickets\ \%\ (within-person)}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0019}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0023}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0014}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Defect\ tickets\ \%}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0060}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0049}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0070}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Degree\ centrality\ (within-person)}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0023}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0040}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0006}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Degree\ centrality}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0040}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0063}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0015}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Comments\ per\ PR\ (within-person)}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0046}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0037}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0054}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Comments\ per\ PR}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0098}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0075}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0120}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 100\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Avg.\ coding\ days/week\ ×\ Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0047}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0098}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0001}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 97\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Total\ merged\ PRs\ ×\ Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0007}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0017}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0003}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 90\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Defect\ tickets\ \%\ ×\ Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0001}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0003}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0001}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 78\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Degree\ centrality\ ×\ Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0001}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0005}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0002}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 71\%}}}} \\





\multicolumn{1}{>{\raggedright}m{\dimexpr 1.25in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Comments\ per\ PR\ ×\ Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0001}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.0004}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.0005}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\ 59\%}}}} \\

\ascline{1.5pt}{666666}{1-5}



\multicolumn{5}{>{\raggedright}m{\dimexpr 4.25in+8\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{1}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Median\ of\ the\ posterior\ distribution,\ used\ as\ point\ estimate}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{2}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{95\%\ Highest\ Density\ Interval,\ containing\ the\ most\ probable\ parameter\ values\ with\ 95\%\ posterior\ probability\ mass}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{3}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Probability\ that\ the\ effect\ is\ in\ the\ reported\ direction,\ calculated\ as\ the\ proportion\ of\ posterior\ samples\ with\ the\ same\ sign\ as\ the\ point\ estimate}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}} \\
...
\multicolumn{1}{>{\raggedright}m{\dimexpr 0.4in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Par}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{1}}}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.4in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Grp}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{2}}}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Stat}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{3}}}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Pred}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{4}}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Post\ Med}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{5}}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{95\%\ HDI}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{6}}}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{Sign\ Prob}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textbf{\textsuperscript{7}}}}}} \\
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Intercept}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.474}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{[0.424,\ 0.529]}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{100\%}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\multirow[t]{-2}{*}{\parbox{0.5in}{\raggedright \textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{SD}}}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.034}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{[0.027,\ 0.042]}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{100\%}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{\multirow[t]{-3}{*}{\parbox{0.4in}{\raggedright \textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{org}}}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Correlation}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Intercept-Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.123}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{[-0.335,\ 0.110]}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{86.15\%}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Intercept}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.645}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{[0.631,\ 0.661]}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{100\%}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\multirow[t]{-2}{*}{\parbox{0.5in}{\raggedright \textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{SD}}}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.067}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{[0.062,\ 0.071]}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{100\%}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{\multirow[t]{-6}{*}{\parbox{0.4in}{\raggedright \textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{log(λ)}}}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{\multirow[t]{-3}{*}{\parbox{0.4in}{\raggedright \textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{org:user}}}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Correlation}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Intercept-Month}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{-0.131}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{[-0.192,\ -0.077]}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{100\%}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{log(k)}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.4in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{org}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{SD}}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Intercept}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{0.277}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{[0.247,\ 0.310]}}}} & \multicolumn{1}{>{\raggedleft}m{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{100\%}}}} \\

\ascline{1.5pt}{666666}{1-7}



\multicolumn{7}{>{\raggedright}m{\dimexpr 3.55in+12\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{1}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Response\ distribution\ parameter\ (λ:\ rate\ parameter,\ k:\ shape\ parameter)}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{2}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Random\ effects\ grouping\ structure}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{3}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Statistic\ type\ (SD:\ standard\ deviation\ of\ random\ effect,\ Correlation:\ correlation\ between\ random\ effects)}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{4}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Fixed\ or\ random\ effect\ term}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{5}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Median\ of\ the\ posterior\ distribution,\ used\ as\ point\ estimate}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{6}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{95\%\ Highest\ Density\ Interval,\ containing\ the\ most\ probable\ parameter\ values\ with\ 95\%\ posterior\ probability\ mass}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{\textsuperscript{7}}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{Probability\ that\ the\ effect\ is\ in\ the\ reported\ direction,\ calculated\ as\ the\ proportion\ of\ posterior\ samples\ with\ the\ same\ sign\ as\ the\ point\ estimate}}}\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{DejaVu Sans}{.\ }}}} \\
...
four key limitations of the current findings in greater detail, using
the framework of internal, external, construct, and statistical
conclusion validity (Vazire, Schiavone, and Bottesini 2022). In general,
these limitations point to the need for more and better empirical
evidence for software engineering (Devanbu, Zimmermann, and Bird 2016;
Kitchenham, Dyba, and Jorgensen 2004; Sjoberg, Dyba, and Jorgensen
2007).
...
complicating our ability to understand cycle time.
...
generalizability of these results (Baltes and Ralph 2021). Moreover,
systematic differences in ticket assignment patterns may complicate
cycle time interpretations. How a ticket and its associated work tasks
are assigned inside of an organization is likely an important factor in
how tickets are completed. Assignment of tickets, especially defect
tickets, is complex over time and both the initial and subsequent
assignments of tickets can be impacted by many factors. For example,
after an initial assignment to a developer, bugs may frequently be
reassigned due to diverse factors such as determining ownership, time
constraints, and identifying developers who may have a particular view
into the root cause of the bug (Guo et al. 2011). Some individuals may
get assigned defect tickets systematically more often than others, and
changes in the proportion of work that consists of defect tickets may
change how fast someone is able to work in general, either because
defect tickets tend to be larger or smaller in scope than other tickets,
or because of disruptions.

\subsection{Internal validity}\label{internal-validity}

Our simplified measurement of team structures fails to capture the
complex collaborative reality of software development. In this analysis,
given limitations in our dataset about contexts such as internal team
structures within organizations, we have operationalized team size with
a generous attribution of team membership across shared activity, which
almost certainly represents a very rough estimate of team size. We have
also calculated team size as averaged in a static measure for the entire
year, rather than captured over time. Given that team size likely
impacts how quickly work is completed, we may miss out on nuanced
effects here; for instance, it is reasonable to imagine that further
variables around how resources are distributed and allocated to teams
may provide further predictive value to our understanding of team-level
factors that change cycle time. Team ``assignment'' itself is also
highly complex in technical work, as cross-team collaboration is
...
Another major issue that threatens internal validity is invisible
collaborative activities and contributor role ambiguity limit
interpretations of cycle time variations. Developers communicate and
collaborate in many ways that may not be captured in a ticket,
e.g.~impromptu or formal mentorship, paired or mob programming, and
planning meetings. Where activity data are collected for some of these
activities, it is likely that such data may be perceived in our data
collection as ``belonging'' to a single individual, but work may often
reflect joint work (e.g., in the case of mentorship, paired, and
planning activities where one developer ``logs'' the work of many).
...
Even using an outcome distribution appropriate to the context (Weibull,
in this case), hierarchical structure to account for nested
non-independence, and an emphasis on effect sizes over dichotomous
significance, our statistical conclusions remain conditional on a
particular modeling representation. First, the model encodes causal and
functional-form assumptions (e.g., additivity, smoothness, and the
exogeneity of our target predictors) that may be only approximately
true; good fit does not preclude biased inferences if these assumptions
are wrong. Second, unmodeled confounders may bias what we infer to be
causal associations. Third, cycle time is a time-evolving, heavy-tailed
process; departures from assumed variance and tail behavior, lagged
dependencies, or feedback (e.g., long tickets begetting process changes
that alter future tickets) can distort estimated associations. Fourth,
inferences depend on operationalization and scaling (e.g., static versus
time-varying team size; alternative definitions of ticket start and
close); different defensible specifications can yield materially
different effect sizes (Giudice and Gangestad 2021). Finally, our
results test a narrow class of models. Together, these considerations
suggest treating our estimates as conditional on the specific model
chosen.
...
frequently seen in the industry. While not necessarily uncommon in this
literature, it is worth mentioning that modeling these factors
simultaneously as continuous variables allows us to get closer to the
idea of ``X has an effect on Y, all else being held equal.'' This is
necessary for starting to figure out the effect of a particular factor
in isolation. Of course, if one has access to even more sophisticated
...
\bibitem[\citeproctext]{ref-bacchelliExpectationsOutcomesChallenges2013}
Bacchelli, Alberto, and Christian Bird. 2013. {``Expectations, Outcomes,
and Challenges of Modern Code Review.''} In \emph{2013 35th
{International Conference} on {Software Engineering} ({ICSE})}, 712--21.
...
Engineering Research}: {A Critical Review} and {Guidelines}.''} October
20, 2021. \url{https://doi.org/10.48550/arXiv.2002.07764}.
...
`Data.frame`}. Manual. \url{https://r-datatable.com}.
...
Productivity.''} May 9, 2024.
\url{https://getdx.com/blog/mckinsey-developer-productivity/}.

\bibitem[\citeproctext]{ref-burknerBrmsPackageBayesian2017}
Bürkner, Paul-Christian. 2017. {``Brms: {An R Package} for {Bayesian
Multilevel Models Using Stan}.''} \emph{Journal of Statistical Software}
80 (1, 1): 1--28. \url{https://doi.org/10.18637/jss.v080.i01}.
...
Code.''} LeadDev. December 5, 2024.
\url{https://leaddev.com/reporting/why-70-of-engineers-avoid-measuring-lines-of-code}.
...
\bibitem[\citeproctext]{ref-cataldoSociotechnicalCongruenceFramework2008}
Cataldo, Marcelo, James D. Herbsleb, and Kathleen M. Carley. 2008.
...
In \emph{Proceedings of the {Second ACM-IEEE} International Symposium on
{Empirical} Software Engineering and Measurement}, 2--11. {ESEM} '08.
...
April 19, 2024.
\url{https://middlewarehq.com/blog/why-50-developers-hate-dora-metrics}.
...
(2): 278--87. \url{https://digitalcommons.kennesaw.edu/facpubs/1581}.
...
February 2, 2023.
\url{https://newsletter.cote.io/p/the-only-people-who-dont-like-metrics}.

\bibitem[\citeproctext]{ref-curranDisaggregationWithinPersonBetweenPerson2011}
...
Reviews}.''} September 23, 2024.
\url{https://doi.org/10.48550/arXiv.2409.15152}.
...
Productivity Wrong}.''} Medium. September 8, 2023.
\url{https://bdfinst.medium.com/5-minute-devops-mckinsey-gets-developer-productivity-wrong-573b57cd6f6a}.

\bibitem[\citeproctext]{ref-flowHowIncreaseSoftware}
Flow. n.d. {``How to Increase Software Delivery Speeds by Reducing Cycle
Time.''}
\url{https://www.pluralsight.com/product/flow/flow-academy/how-to-improve-cycle-time}.

\bibitem[\citeproctext]{ref-forsgrenAccelerateScienceDevOps2018}
Forsgren, Nicole, Jez Humble, and Gene Kim. 2018. \emph{Accelerate: The
Science Behind {DevOps}: Building and Scaling High Performing Technology
Organizations}. First edition. Portland, Oregon: IT Revolution.
...
\bibitem[\citeproctext]{ref-giudiceTravelersGuideMultiverse2021}
Giudice, Marco Del, and Steven W. Gangestad. 2021. {``A {Traveler}'s
...
\bibitem[\citeproctext]{ref-gousiosExploratoryStudyPullbased2014}
Gousios, Georgios, Martin Pinzger, and Arie Van Deursen. 2014. {``An
Exploratory Study of the Pull-Based Software Development Model.''} In
\emph{Proceedings of the 36th {International Conference} on {Software
Engineering}}, 345--55. Hyderabad India: ACM.
\url{https://doi.org/10.1145/2568225.2568260}.

\bibitem[\citeproctext]{ref-gralhaReduceCycleTime2022}
Gralha, Catarina. 2022. {``Reduce Cycle Time - Best Practices.''} August
18, 2022. \url{https://blog.codacy.com/reducing-cycle-time}.
...
Group, NISO CRediT Working. 2022. \emph{{ANSI}/{NISO Z39}.104-2022,
...
Developer Experience Take Hold} or {Fail}.''} January 25, 2024.
...
Theory} for {Developer Problem-Solving}.''} November 21, 2024.
...
April 20, 2024. \url{https://doi.org/10.31234/osf.io/2gej5}.
...
Pluralsight.
\url{https://www.pluralsight.com/resource-center/guides/developer-thriving-research-paper}.
...
Metrics.''} LeadDev. May 11, 2023.
\url{https://leaddev.com/reporting/why-elite-dev-teams-focus-pull-request-metrics}.
...
{McKinsey}, {Part} 2.''} October 22, 2024.
...
on {Lead Time}: {An Industrial Case Study}.''} June 3, 2024.
...
Manual. \url{https://patchwork.data-imaginist.com}.
...
{R} Graphs}. Manual. \url{https://github.com/yixuan/showtext}.
...
Productivity.''} LeadDev. October 23, 2023.
\url{https://leaddev.com/career-development/what-mckinsey-got-wrong-about-developer-productivity}.

\bibitem[\citeproctext]{ref-riosaWrittenUnwrittenGuide2019}
Riosa, Blake. 2019. {``The (Written) Unwritten Guide to Pull
Requests.''} Work Life by Atlassian. July 25, 2019.
...
Interface to {Stan}.''} \url{https://mc-stan.org/}.
...
and {Reference Manual}, 2.35.''} \url{https://mc-stan.org}.

\bibitem[\citeproctext]{ref-terhorst-northWorstProgrammerKnow2023}
Terhorst-North, Daniel. 2023a. {``The {Worst Programmer I Know}.''} Dan
North \& Associates Limited. September 2, 2023.
\url{https://dannorth.net/the-worst-programmer/}.

\bibitem[\citeproctext]{ref-terhorst-northMcKinseyDeveloperProductivity2023}
---------. 2023b. {``{McKinsey Developer Productivity Review}.''} Dan
North \& Associates Limited. October 4, 2023.
\url{https://dannorth.net/mckinsey-review/}.

\bibitem[\citeproctext]{ref-toxboeCycleTime2023}
Toxboe, Anders. 2023. {``Cycle {Time}.''} Learning Loop. February 10,
2023. \url{https://learningloop.io/glossary/cycle-time}.
...
\bibitem[\citeproctext]{ref-vazireCredibilityReplicabilityImproving2022}
Vazire, Simine, Sarah R. Schiavone, and Julia G. Bottesini. 2022.
{``Credibility {Beyond Replicability}: {Improving} the {Four Validities}
in {Psychological Science}.''} \emph{Current Directions in Psychological
Science} 31 (2): 162--68.
...
\textbar{} {Aviator}.''} January 18, 2023.
...
\textbar{} {Aviator}.''} February 27, 2023.
\url{https://www.aviator.co/blog/whats-wrong-with-using-space-to-measure-developer-productivity/}.

\bibitem[\citeproctext]{ref-wattsNewScienceNetworks2004}
Watts, Duncan J. 2004. {``The {`{New}'} {Science} of {Networks}.''}
\emph{Annual Review of Sociology} 30 (August): 243--70.
...
Metric} to {Accelerate Software Delivery}.''} July 26, 2021.
\url{https://waydev.co/reduce-cycle-time/}.
