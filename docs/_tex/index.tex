...
Organization sizes clustered around 130 users, with a long tail of
larger organizations.

}

\caption[Histogram of organization sizes in the
dataset.]{\label{fig-org-size}Note that ``users'' generally refers to
developers or other individuals creating and closing tickets.}
