...
::: {#fig-quarter fig-scap="Within-quarter month effect on cycle time" fig-alt="Effect of within-quarter month on cycle time"}

![](plots/cycle_time_full_intx_lin_remonth_quarter.png)

Effect of within-quarter month. Background hexagons represent density of data, with darker colors indicating greater density. Lines are median posterior expectations, with 95% credible interval ribbons.

:::


::: {#fig-month fig-scap="Month effect on cycle time" fig-alt="Effect of month on cycle time"}

![](plots/cycle_time_full_intx_lin_remonth_month_num.png)

Effect of month. Background hexagons represent density of data, with darker colors indicating greater density. Lines are median posterior expectations, with 95% credible interval ribbons.
...
::: {#fig-codingdays fig-scap="Coding days per week effect on cycle time" fig-alt="Effect of average coding days per week on cycle time"}

![](plots/cycle_time_full_intx_lin_remonth_coding_days.png)

Effect of average coding days per week on cycle time. Background hexagons represent density of data, with darker colors indicating greater density. Lines are median posterior expectations, with 95% credible interval ribbons.
...
::: {#fig-mergedprs fig-scap="Merged PRs effect on cycle time" fig-alt="Effect of merged PRs on cycle time"}

![](plots/cycle_time_full_intx_lin_remonth_merged_prs.png)

Effect of merged PRs on cycle time. Background hexagons represent density of data, with darker colors indicating greater density. Lines are median posterior expectations, with 95% credible interval ribbons.
...
::: {#fig-defecttickets fig-scap="Defect tickets effect on cycle time" fig-alt="Effect of percent defect tickets on cycle time"}

![](plots/cycle_time_full_intx_lin_remonth_defect_tickets.png)

Effect of percent defect tickets on cycle time. Background hexagons represent density of data, with darker colors indicating greater density. Lines are median posterior expectations, with 95% credible interval ribbons.
...
::: {#fig-degree fig-scap="Degree centrality effect on cycle time" fig-alt="Effect of degree centrality on cycle time"}

![](plots/cycle_time_full_intx_lin_remonth_degree_cent.png)

Effect of degree centrality on cycle time. Background hexagons represent density of data, with darker colors indicating greater density. Lines are median posterior expectations, with 95% credible interval ribbons.
...
::: {#fig-comments fig-scap="Comments per PR effect on cycle time" fig-alt="Effect of comments per PR on cycle time"}

![](plots/cycle_time_full_intx_lin_remonth_pr_comments.png)

Effect of comments per PR on cycle time. Background hexagons represent density of data, with darker colors indicating greater density. Lines are median posterior expectations, with 95% credible interval ribbons.
...
::: {#fig-heatmaps layout="[[333,333,333],[-166,333,333,-166]]" fig-scap="Expected change in cycle time from 50th to 90th percentile of each variable" fig-alt="Expected change in cycle time from 50th to 90th percentile of each variable, by organization and month"}

![](plots/avg_coding_days_per_week_eff_size.png){#fig-heatmaps-coding}

Avg. coding days per Week

![](plots/total_merged_prs_eff_size.png){#fig-heatmaps-prs}

Total merged PRs

![](plots/defect_tickets_pct_indiv_eff_size.png){#fig-heatmaps-defects}

Defect tickets percentage

![](plots/degree_centrality_monthly_100_eff_size.png){#fig-heatmaps-centrality}

Degree centrality

![](plots/comments_per_pr_eff_size.png){#fig-heatmaps-comments}

Comments per PR

Expected change in cycle time from 50th to 90th percentile of each variable, by organization and month. The color represents the expected change in cycle time, with warm indicating an increase in cycle time and cool indicating a decrease. The scale is the same across all plots.
:::
...
::: {#fig-pp-check-org fig-scap="Cycle Time Variability Across Organizations" fig-alt="Cycle Time Variability Across Organizations"}

![](plots/cycle_time_full_intx_nlq_pp_check.png)

Posterior prediction densities for model-expected distributions of cycle time across all orgs with at least 10 observations. Each row is one organization, showing the density of predicted cycle times from 50 model simulations. The scale has been transformed to better show the spread of data. Columns have been ordered by sample size, and rows are ordered by median predicted cycle time. Density fill colors reflect sample size. Note that distributions from larger orgs have less variability in their posterior predictions. Line at 4 weeks is set arbitrarily to allow comparisons

:::


::: {#fig-pp-check-sum fig-scap="Posterior Prediction Distributions of Cycle Time for all data" fig-alt="Posterior Prediction Distributions of Cycle Time for all data"}

![](plots/cycle_time_full_intx_nlq_pp_check_summary.png)

Posterior Prediction Distributions of Cycle Time for all data
...
::: {#fig-bw-ct-traj fig-scap="Between-person effects on cycle-time trajectories" fig-alt="Between-person effects on cycle-time trajectories across the year for randomly-sampled individuals."}

![](plots/cycle_time_full_intx_lin_remonth_post_pred_ids.png)

Between-person effects on cycle-time trajectories across the year for randomly-sampled individuals.
...
::: {#fig-wi-ct-traj fig-scap="Within-person effects on cycle-time trajectories" fig-alt="Within-person effects on cycle-time trajectories across the year for randomly-sampled individuals."}

![](plots/cycle_time_full_intx_nlq_post_pred_ids_win.png)

Within-person effects on cycle-time trajectories across the year for randomly-sampled individuals.
